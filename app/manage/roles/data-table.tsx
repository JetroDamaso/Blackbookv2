...
import { createRole, deleteRole } from "@/server/role/pushActions";
    ...
    try {
      await Promise.all(
        selectedRows.map(row => {
          const role = row.original as { id: number };
    ...
    <div className="flex flex-col">
      <div className="flex gap-2 items-center mb-2">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle className="mb-4">Add Role</DialogTitle>
              <DialogDescription>
                <div className="grid gap-4">
                  <div className="grid items-center gap-3">
                    ...
                    <Input
                      type="text"
                      id="name"
                      placeholder="Admin, Manager, Staff, etc."
                      value={formData.name}
                      onChange={e =>
                        setFormData(prev => ({
                          ...prev,
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will delete {selectedRows.length} role{selectedRows.length > 1 ? "s" : ""}. This
